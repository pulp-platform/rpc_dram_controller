...
## Clock Signal
set_property -dict { PACKAGE_PIN AD11  IOSTANDARD LVDS     } [get_ports { clkp_i }]; #IO_L12N_T1_MRCC_33 Sch=sysclk_n
set_property -dict { PACKAGE_PIN AD12  IOSTANDARD LVDS     } [get_ports { clkn_i }]; #IO_L12P_T1_MRCC_33 Sch=sysclk_p
...
#set_property -dict { PACKAGE_PIN P27   IOSTANDARD LVCMOS33 } [get_ports { test_i }]; #IO_L8P_T1_D11_14 Sch=sw[7]
